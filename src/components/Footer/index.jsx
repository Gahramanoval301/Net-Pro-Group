        ...
        <Box bgcolor="primary.main">
            <Container className={styles.container}>
                <Grid container py={3}>
                    ...
                    <Grid item p={1} xs={12} sm={6} md={3}>
                        <Typography mb={2} variant='h5' component='h5'>
                            Əlaqə
                        </Typography>
                        ...
                        <a href="tel:+99450 5754080"
                            style={{
                                color: alpha("#fff", 0.5), textDecoration: "none", display: 'block'
                            }}>
                            +99450 5754080
                        </a>
                        <a href="tel:+99450 5754070"
                            style={{
                                color: alpha("#fff", 0.5), textDecoration: "none"
                            }}>
                            +99450 5754070
                        </a>
                        <Typography mt={4} mb={1} variant='h5' component='h5'>
                            <Email sx={{ mr: 2 }} />
                            Email
                        </Typography>
                        <a href="mailto:info@netprogroup.az"
                            style={{
                                color: alpha("#fff", 0.5), textDecoration: "none"
                            }}>
                            info@netprogroup.az
                ...
                <Divider sx={{
                    bgcolor: alpha("#fff", 0.5), mb: 2
                }} />
                <Stack pb={2}
                    flexDirection="row"
                    justifyContent="space-between"
                    flexWrap="wrap">
                    <Typography color={alpha("#fff", 0.9)}>
                        Copyright © NETPRO GROUP MMC - 2022
                    </Typography>
                    <Typography color={alpha("#fff", 0.9)}>
                        Site by Leman Gahramanova
                    </Typography>
                </Stack>
            </Container>
        </Box>
